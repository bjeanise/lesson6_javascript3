...
//the leftArrow() function will be executed when the user clicks the left navigation
//arrow button.

leftarrow.addEventListener("click", leftArrow, false);

//declare variable for document element with id of rightarrow in the html
//document

var rightarrow = document.getElementById("rightarrow");

//add an event handler to the specified document element(rightarrow)
/*the right Arrow() function will be executed when user clicks the
...
//when the user clicks the ShowMore button the previewFive function is executed
